import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-3MPEUIV4.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-U64LECS4.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-WOP3T57L.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-ILN2ZNNS.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
...
//# sourceMappingURL=chunk-7EOWJHMN.js.map
